...
import { settingsGroups } from "@/lib/super-admin-data";
...
function SystemConfiguration() {
  return (
    <div className="space-y-6">
      <PageHeader title="System Configuration" desc="Configure institutional communication, academic cycle, backup and display preferences." />
            ...
            <Card key={group.title} className="hover:-translate-y-1 transition">
              ...
              <div className="space-y-2 mt-4">
                {group.items.map(item => (
                  <div key={item} className="flex items-center justify-between p-2.5 rounded-lg border bg-gradient-soft">
      ...
      <Card>
        ...
        <div className="space-y-4 p-4 border rounded-xl bg-gradient-soft">
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-4">
            <input defaultValue="College Management System" className="rounded-lg border bg-background px-3 py-2 text-sm" />
            <input defaultValue="2026-2027" className="rounded-lg border bg-background px-3 py-2 text-sm" />
          ...
          <div className="grid sm:grid-cols-2 gap-4">
            <textarea defaultValue="admin@college.edu" rows={3} className="rounded-lg border bg-background px-3 py-2 text-sm" />
            <textarea defaultValue="Primary email, SMS and dashboard notifications are enabled for critical events." rows={3} className="rounded-lg border bg-background px-3 py-2 text-sm" />
          </div>
