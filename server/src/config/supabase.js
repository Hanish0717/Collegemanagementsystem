...
if (isMockMode) {
  ...
  let db = {
    users: [
      ...
      { id: 'hocse111-1111-1111-1111-111111111111', name: 'HOD CSE',   full_name: 'Dr. Anjali Mehra',   email: 'hod.cse@college.com',   password: hashedDefaultPassword, role: 'hod', department: 'CSE',   is_verified: true, is_active: true },
      { id: 'hoaiml11-1111-1111-1111-111111111111', name: 'HOD AIML',  full_name: 'Dr. HOD AIML',       email: 'hod.aiml@college.com',  password: hashedDefaultPassword, role: 'hod', department: 'AIML',  is_verified: true, is_active: true },
      { id: 'hoece111-1111-1111-1111-111111111111', name: 'HOD ECE',   full_name: 'Dr. Ramesh Kumar',   email: 'hod.ece@college.com',   password: hashedDefaultPassword, role: 'hod', department: 'ECE',   is_verified: true, is_active: true },
      { id: 'hoeee111-1111-1111-1111-111111111111', name: 'HOD EEE',   full_name: 'Dr. Suresh Varma',   email: 'hod.eee@college.com',   password: hashedDefaultPassword, role: 'hod', department: 'EEE',   is_verified: true, is_active: true },
      { id: 'homech11-1111-1111-1111-111111111111', name: 'HOD MECH',  full_name: 'Dr. Vikram Rathore', email: 'hod.mech@college.com',  password: hashedDefaultPassword, role: 'hod', department: 'MECH',  is_verified: true, is_active: true },
      { id: 'hocivl11-1111-1111-1111-111111111111', name: 'HOD CIVIL', full_name: 'Dr. Rajesh Gupta',   email: 'hod.civil@college.com', password: hashedDefaultPassword, role: 'hod', department: 'CIVIL', is_verified: true, is_active: true },
      { id: 'hoit1111-1111-1111-1111-111111111111', name: 'HOD IT',    full_name: 'Dr. Neha Sharma',    email: 'hod.it@college.com',    password: hashedDefaultPassword, role: 'hod', department: 'IT',    is_verified: true, is_active: true },
      { id: 'ho111111-1111-1111-1111-111111111111', name: 'HOD CSE',   full_name: 'HOD CSE Dept',       email: 'hod@college.com',       password: hashedDefaultPassword, role: 'hod', department: 'CSE',   is_verified: true, is_active: true },
  ...
  getMockDb = () => {
      ...
      currentDb['assessments'] = [
        {
          ...
          recruiter_id: 'co111111-1111-1111-1111-111111111111',
          company_id: 'c1111111-1111-1111-1111-111111111111',
          company_name: 'TechCorp Solutions',
          assessment_name: 'Round 1: General Aptitude & Problem Solving',
          ...
          created_by: 'Sarah Jenkins (TechCorp Recruiter)',
        ...
        },
        {
          ...
          company_id: 'c1111111-1111-1111-1111-111111111111',
          company_name: 'TechCorp Solutions',
          assessment_name: 'Round 2: Core Technical & Data Structures',
        ...
        },
        {
          ...
          assessment_name: 'Innovate Systems Full-Stack Skill Challenge',
          description: 'Comprehensive skill test for Software Development Engineer role.',
          instructions: 'Webcam proctoring required.',
          passing_marks: 90,
          total_marks: 150,
          duration: 120,
          current_status: 'Submitted_to_TPO',
          created_by: 'Alex Rivera (Innovate HR)',
    ...
    if (!currentDb['assessment_status_history'] || currentDb['assessment_status_history'].length === 0) {
      currentDb['assessment_status_history'] = [
        {
          id: 'ash-101',
        ...
        },
        {
          ...
          to_status: 'Approved',
          changed_by: 'Placement Officer Office',
    ...
    if (!currentDb['assessment_timeline'] || currentDb['assessment_timeline'].length === 0) {
      currentDb['assessment_timeline'] = [
        {
          id: 'atl-101',
          assessment_id: 'asm-10111111-1111-1111-1111-111111111111',
          event_type: 'CREATED',
          title: 'Assessment Foundation Created',
          description: 'Assessment "Round 1: General Aptitude & Problem Solving" was initialized.',
          actor_name: 'Sarah Jenkins',
          actor_role: 'Company Recruiter',
          created_at: new Date(Date.now() - 3 * 86400000).toISOString()
        },
        {
          id: 'atl-102',
          ...
          title: 'Submitted to TPO',
          description: 'Assessment specifications submitted to Training & Placement Officer.',
          actor_name: 'Sarah Jenkins',
          actor_role: 'Company Recruiter',
          created_at: new Date(Date.now() - 2.5 * 86400000).toISOString()
        },
        {
          ...
          assessment_id: 'asm-10111111-1111-1111-1111-111111111111',
          event_type: 'APPROVED',
          title: 'Assessment Approved by TPO',
          description: 'TPO reviewed and verified assessment total marks and syllabus.',
          actor_name: 'Dr. Ramesh Kumar',
          actor_role: 'Placement Officer',
          created_at: new Date(Date.now() - 2 * 86400000).toISOString()
        },
        {
          id: 'atl-104',
          ...
          description: 'Scheduled for August 5th 10:00 AM in Computer Lab 1 & 2.',
          actor_name: 'Placement Operations',
          actor_role: 'Placement Officer',
          created_at: new Date(Date.now() - 1 * 86400000).toISOString()
        }
      ];
