        ...
        <Card className="lg:col-span-2">
          ...
          <div className="space-y-2">
            {hostelNotificationsList.map((notification) => (
              <div
                key={notification.id}
                className={`flex items-center gap-3 p-4 rounded-xl border hover:bg-accent/50 transition cursor-pointer ${notification.read ? "" : "bg-blue-50 border-blue-200"}`}
              >
                <div
                  className={`size-10 rounded-lg ${notification.priority === "High" ? "bg-gradient-primary" : notification.priority === "Medium" ? "bg-gradient-violet" : "bg-gradient-cyan"} text-white grid place-items-center`}
                >
        ...
        <Card>
          ...
          <div className="space-y-2">
            {[
              ...
              <button
                key={filter.label}
                className="w-full flex items-center justify-between p-3 rounded-xl border hover:bg-accent/50 transition"
              >
            ...
            {[
              ...
              >
                <div className="flex items-center justify-between">
                  ...
                  <Badge tone={reminder.daysLeft === 0 ? "danger" : "warn"}>
        ...
        <Card>
          ...
          <div className="space-y-2">
            {[
              ...
              <div
                key={emergency.title}
                className="p-3 rounded-xl border bg-rose-50 border-rose-200 hover:bg-accent/50 transition"
              >
                <div className="flex items-center justify-between">
                  <div>
