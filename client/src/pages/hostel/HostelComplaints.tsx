...
import { complaints, complaintStatusData } from "@/mock/hostelData";
      ...
      <Card>
        <div className="flex flex-col lg:flex-row gap-3">
          <div className="flex-1 relative">
            ...
            <input
              placeholder="Search by complaint ID, student name..."
          ...
          <select className="rounded-xl border bg-background/60 px-4 py-2.5 text-sm">
            {["All Status", "Resolved", "In Progress", "Pending", "Escalated"].map((s) => (
          ...
          <div className="space-y-2">
            {complaints
              ...
              .map((complaint) => (
                <div
                  key={complaint.id}
                  className="p-3 rounded-xl border bg-rose-50 border-rose-200 hover:bg-accent/50 transition cursor-pointer"
                >
                  <div className="flex items-center justify-between">
                    <div>
                      <div className="text-sm font-medium">{complaint.title}</div>
          ...
          {[
            ...
            >
              ...
              <div className="flex-1">
                ...
                <div className="text-xs text-muted-foreground">
                  Resolved in {resolution.resolvedIn} by {resolution.by}
                </div>
              </div>
