        ...
        <Card>
          ...
          <div className="space-y-2">
            {hostelNotifications.map((notification) => (
              <div
                key={notification.id}
                className={`flex items-center gap-3 p-3 rounded-xl border hover:bg-accent/50 transition cursor-pointer ${notification.unread ? "bg-blue-50 border-blue-200" : ""}`}
              >
        ...
        <Card>
          ...
          <div className="grid grid-cols-2 gap-4">
            {[
              ...
              <button
                key={action.label}
                className="p-4 rounded-xl bg-gradient-soft border hover:bg-accent/50 transition flex flex-col items-center gap-2"
              >
                <div
