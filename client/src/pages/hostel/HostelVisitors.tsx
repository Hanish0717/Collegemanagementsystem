      ...
      <Card>
        <div className="flex flex-col lg:flex-row gap-3">
          <div className="flex-1 relative">
            ...
            <input
              placeholder="Search by visitor name, student name..."
          ...
          <select className="rounded-xl border bg-background/60 px-4 py-2.5 text-sm">
            {["All Status", "Inside", "Checked Out", "Pending"].map((s) => (
                ...
                {visitorLogs.map((log) => (
                  <tr key={log.visitorName} className="hover:bg-accent/50 transition">
                    ...
                    <td className="py-3 px-4 text-muted-foreground">
                      {log.exitTime || <span className="text-muted-foreground">-</span>}
                    </td>
          ...
          <div className="space-y-2">
            {[
              ...
              >
                ...
                <Badge tone={verification.status === "Verified" ? "success" : "warn"}>
                  {verification.status}
                </Badge>
              </div>
            ))}
              ...
              >
                <div className="flex items-center justify-between">
                  ...
                  <div className="flex gap-2">
                    <button className="px-2 py-1 rounded text-xs bg-emerald-100 text-emerald-700 hover:bg-emerald-200 transition">
                      Approve
                    </button>
                    <button className="px-2 py-1 rounded text-xs bg-rose-100 text-rose-700 hover:bg-rose-200 transition">
                      Reject
                    </button>
                  </div>
                </div>
