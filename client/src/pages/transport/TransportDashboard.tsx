            ...
            <div className="flex items-center gap-3">
              ...
              <div className="flex-1">
                ...
                <div className="text-[11px] text-muted-foreground flex items-center gap-1">
                  <User className="size-3" /> {b.driver}
                </div>
              </div>
            </div>
      ...
      <Card>
        ...
        <div className="relative h-80 rounded-2xl overflow-hidden bg-gradient-soft border">
          ...
          {[
            ...
            >
              <div
                className={`size-10 rounded-full ${p.c} text-white grid place-items-center text-[10px] font-bold animate-pulse-glow`}
              >
                {p.n}
              </div>
            </div>
          ...
          <svg className="absolute inset-0 w-full h-full opacity-30">
            <path
              d="M 60 120 Q 200 80 320 200 T 600 100"
              stroke="#4F46E5"
              strokeWidth="2"
              strokeDasharray="6 6"
              fill="none"
