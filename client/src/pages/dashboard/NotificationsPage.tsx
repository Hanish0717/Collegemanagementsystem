...
export function NotificationsPage() {
  ...
  return (
    <div className="space-y-6">
      <PageHeader
        title="Notifications"
        desc="Stay on top of every alert across the campus."
      />

      {/* Stats */}
      <div className="grid lg:grid-cols-3 gap-4">
        {[
          { icon: Info, label: "Info", sublabel: "this week", value: notificationsList.length, gradient: "bg-gradient-cyan" },
          { icon: AlertTriangle, label: "Alerts", sublabel: "this week", value: alertCount, gradient: "bg-gradient-violet" },
          { icon: CheckCircle2, label: "Completed", sublabel: "this week", value: completedCount, gradient: "bg-gradient-primary" },
        ].map((s) => (
          <Card key={s.label}>
            <div className="flex items-center gap-3">
              <div className={`size-11 rounded-xl ${s.gradient} text-white grid place-items-center`}>
                ...
                >
                  ...
                  <div className="flex-1 min-w-0">
                    <div className="flex items-center justify-between gap-2">
                      <span className={`text-sm font-medium truncate ${n.unread ? "font-semibold" : ""}`}>
                        {n.title}
                      </span>
