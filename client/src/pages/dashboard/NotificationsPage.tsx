        ...
        <div className="relative flex items-center gap-4">
          ...
          <div className="flex-1">
            ...
            <div className="text-sm opacity-90">
              All students must download hall tickets before June 10.
            </div>
          </div>
          <button className="px-4 py-2 rounded-xl bg-white text-foreground text-sm font-medium">
            View
          </button>
        </div>
      </Card>
        ...
        {[
          ...
          <Card key={s.l}>
            <div className="flex items-center gap-3">
              <div className={`size-11 rounded-xl ${s.c} text-white grid place-items-center`}>
      ...
      <Card>
        ...
        <div className="space-y-2">
          {notifications.map((n, i) => (
            <div
              key={i}
              className={`flex items-center gap-3 p-3 rounded-xl border ${n.unread ? "bg-gradient-soft" : ""}`}
            >
