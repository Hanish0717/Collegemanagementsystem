    ...
    <div className="space-y-6">
      <PageHeader
        ...
        actions={
          <>
            ...
            <button className="inline-flex items-center gap-1.5 px-3 py-2 rounded-xl bg-gradient-primary text-white text-sm glow-primary">
          ...
          <Card key={s.id} className="text-center">
            ...
            <div className="mt-3 grid grid-cols-2 gap-2 text-xs">
              <div className="rounded-lg bg-muted/60 p-2">
                <div className="font-bold">{s.attendance}%</div>
                <div className="text-muted-foreground">Attendance</div>
              </div>
              <div className="rounded-lg bg-muted/60 p-2">
                <div className="font-bold">{s.cgpa}</div>
                <div className="text-muted-foreground">CGPA</div>
              </div>
            </div>
            <div className="mt-3 flex justify-center gap-1.5">
              <button className="size-8 rounded-lg border grid place-items-center hover:bg-accent">
      ...
      <Card className="p-0 overflow-hidden">
              ...
              {students.map((s) => (
                <tr key={s.id} className="border-t hover:bg-muted/30">
                  ...
                  <td className="px-5 py-3 text-right">
                    <button className="text-indigo text-xs font-medium hover:underline">
                      View
                    </button>
                  </td>
                </tr>
        ...
        <div className="p-4 flex items-center justify-between text-xs text-muted-foreground border-t">
          <span>
            Showing 1–{students.length} of {students.length}
          </span>
