    ...
    <div className="space-y-6">
      ...
      <div className="grid lg:grid-cols-3 gap-4">
        <Card className="lg:col-span-1 text-center">
          <div className="mx-auto size-24 rounded-3xl bg-gradient-primary grid place-items-center text-white text-3xl font-bold">
            AM
          </div>
          ...
          <button className="mt-5 w-full rounded-xl bg-gradient-primary text-white text-sm py-2 glow-primary">
            Edit profile
          </button>
        </Card>
        ...
        <Card>
          ...
          {[
            ...
            >
              ...
              <button
                className={`relative w-11 h-6 rounded-full transition ${v ? "bg-gradient-primary" : "bg-muted"}`}
              >
                <span
                  className={`absolute top-0.5 size-5 rounded-full bg-white transition ${v ? "left-5" : "left-0.5"}`}
                />
              </button>
            </div>
          ))}
