...
import { books } from "@/mock/mockData";
    ...
    <div className="space-y-6">
      ...
      <Card>
        <div className="flex items-center gap-3">
          ...
          <button className="px-4 py-2.5 rounded-xl bg-gradient-primary text-white text-sm glow-primary">
            Search
          </button>
        </div>
      </Card>
        ...
        {books.map((b) => (
          <Card key={b.id} className="hover:-translate-y-1 transition">
            ...
            <div className="mt-3 flex items-center justify-between">
              ...
              <Badge tone={b.available > 0 ? "success" : "danger"}>
                {b.available > 0 ? `${b.available} available` : "Unavailable"}
              </Badge>
            </div>
            <button
              disabled={b.available === 0}
              className="mt-4 w-full rounded-xl bg-gradient-primary text-white text-sm py-2 disabled:opacity-50 glow-primary"
            >
