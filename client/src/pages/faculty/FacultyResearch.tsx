...
export function FacultyResearch() {
  ...
  const [projects, setProjects] = useState([
    { id: "P001", title: "Autonomous Drone Navigation via Deep Reinforcement Learning", role: "Principal Investigator (PI)", agency: "DST-SERB, Govt of India", budget: "₹18.5L", status: "Ongoing", duration: "2024 - 2026" },
    { id: "P002", title: "Decentralized Smart Grid Energy Distribution using Blockchain", role: "Co-PI", agency: "AICTE Research Grant", budget: "₹8.2L", status: "Ongoing", duration: "2024 - 2025" },
    { id: "P003", title: "Real-time Medical Diagnostics on Edge Devices via Model Compression", role: "Principal Investigator (PI)", agency: "ICMR Research Fellowship", budget: "₹12.0L", status: "Completed", duration: "2022 - 2024" },
    { id: "P004", title: "Energy-efficient Federated Learning for IoT Network Anomalies", role: "Co-PI", agency: "IEEE Seed Funding", budget: "₹3.5L", status: "Completed", duration: "2023 - 2024" }
  ]);
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid md:grid-cols-4 gap-4">
        {[
          { label: "Active Projects", value: String(projects.filter(p => p.status === "Ongoing").length), tone: "info" as const },
          { label: "Completed Projects", value: String(projects.filter(p => p.status === "Completed").length), tone: "success" as const },
          { label: "Total Funding Secured", value: `₹${totalBudgetVal.toFixed(1)}L`, tone: "success" as const },
          ...
          <div className="overflow-x-auto">
            <table className="w-full text-sm">
              <thead className="border-b">
                <tr>
                  {["Project ID & Title", "Role", "Sponsor Agency", "Budget", "Status", "Actions"].map(col => (
                  ...
                  filteredProjects.map(p => (
                    <tr key={p.id} className="hover:bg-accent/40 transition">
                      ...
                      <td className="py-4 px-4">
                        <Badge tone={p.status === "Ongoing" ? "info" : "success"}>
                          {p.status}
                        </Badge>
                      </td>
                      <td className="py-4 px-4">
        ...
        <div className="space-y-6">
          ...
          <Card>
            ...
            <form onSubmit={handleAddProject} className="space-y-3">
              ...
              <div className="flex flex-col gap-1">
                <label className="text-xs font-semibold text-muted-foreground">Sponsoring Agency</label>
                <input
                  value={newAgency}
              ...
              <div className="grid grid-cols-2 gap-2">
                <div className="flex flex-col gap-1">
                  <label className="text-xs font-semibold text-muted-foreground">Budget (Lakhs)</label>
                  <input
                    value={newBudget}
