  ...
  return (
    <div className="space-y-6">
      <PageHeader
        ...
        desc="Manage profile, security settings, notification preferences and teaching configuration."
      />
      ...
      <div className="grid lg:grid-cols-2 gap-4">
        <Card>
          ...
          <div className="space-y-4 p-4 border rounded-xl bg-gradient-soft">
            ...
            <textarea
              defaultValue="Specializing in Data Structures and Algorithms with 12 years of teaching experience."
              rows={4}
