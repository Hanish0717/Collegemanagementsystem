  ...
  const [publications, setPublications] = useState([
    {
      id: 'PUB001',
      title:
        'A Deep Reinforcement Learning Framework for Autonomous Collision Avoidance in Multi-UAV Systems',
      venue: 'IEEE Transactions on Intelligent Transportation Systems',
      authors: 'J. Smith, A. Patel, M. Rossi',
      year: '2024',
      type: 'Journal',
      metrics: 'IF: 9.55 | Citations: 12',
    },
    {
      id: 'PUB002',
      title: 'Hybrid Consensus Mechanisms for Scalable Energy Transactions in Smart Microgrids',
      venue: 'ACM Transactions on Cyber-Physical Systems',
      authors: 'J. Smith, R. Kumar',
      year: '2023',
      type: 'Journal',
      metrics: 'IF: 4.88 | Citations: 28',
    },
    {
      id: 'PUB003',
      title: 'Robust Face Detection on Low-Power IoT Devices via Neural Network Binarization',
      venue: 'International Conference on Computer Vision (ICCV)',
      authors: 'A. Khan, J. Smith',
      year: '2023',
      type: 'Conference',
      metrics: 'H5-index: 156 | Citations: 45',
    },
    {
      id: 'PUB004',
      title: 'Smart Contracts for Federated Decentralized Ledger in Logistics Operations',
    ...
    <div className="space-y-6">
      ...
      <div className="grid md:grid-cols-4 gap-4">
        {[
          ...
          {
            label: 'Journal Papers (SCI/Scopus)',
            value: String(publications.filter((p) => p.type === 'Journal').length),
            tone: 'success' as const,
          },
          {
            label: 'Conference Papers',
            value: String(publications.filter((p) => p.type === 'Conference').length),
            tone: 'warn' as const,
          },
