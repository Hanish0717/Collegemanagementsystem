    ...
    <div className="space-y-6">
                      ...
                      <tr key={time}>
                        ...
                        {days.map((day) => {
                          const slot = slots.find(
                            (s) => s.day === day && (s.start_time === time || s.time === time),
                          );
                          return (
        ...
        <Card>
          <div className="flex justify-between items-center mb-3">
            <h3 className="font-semibold text-slate-800 text-sm">
              Syllabus Coverage &amp; Academic Audit
            </h3>
      ...
      {activeTab === 'feedback' && (
        <Card>
          <div className="flex justify-between items-center mb-3">
            <h3 className="font-semibold text-slate-800 text-sm">
              Faculty Performance Feedback &amp; Review
            </h3>
            <button
              onClick={() => {
                toast.loading('Broadcasting feedback form reminders to student portals...', {
                  duration: 1500,
                });
                setTimeout(() => {
