...
import { attendanceMonitoring, departmentDistributionAdmin, studentAnalytics } from "@/mock/adminData";
          ...
          <div className="h-72">
            <ResponsiveContainer>
              <AreaChart data={studentAnalytics}>
                ...
                <Area type="monotone" dataKey="enrolled" stroke="#4F46E5" fill="url(#report-enrolled)" strokeWidth={2} />
              </AreaChart>
            </ResponsiveContainer>
          </div>
        </Card>
      ...
      <Card>
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-3">
          {[
            ...
            <button key={report.name} className="p-4 rounded-xl border text-left hover:border-primary hover:bg-accent/50 transition">
      ...
      <div className="grid lg:grid-cols-2 gap-4">
        <Card>
          ...
          <div className="space-y-3">
            {[
              { name: "Dr. Rajesh Kumar", department: "Computer Science", rating: "4.8", classes: "124" },
              ...
              <div key={faculty.name} className="flex items-center justify-between p-3 rounded-xl border hover:bg-accent/50 transition">
                <div>
        ...
        <Card>
          ...
          <div className="space-y-3">
            {[
              ...
              <div key={dept.name} className="flex items-center justify-between p-3 rounded-xl border hover:bg-accent/50 transition">
