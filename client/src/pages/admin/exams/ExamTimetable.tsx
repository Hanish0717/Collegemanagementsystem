...
export function ExamTimetable() {
  const [timetable, setTimetable] = useState([
    { id: "T001", subject: "Data Structures", date: "2026-07-14", time: "09:00 AM - 12:00 PM", room: "LH-101", supervisor: "Dr. John Smith" },
    { id: "T002", subject: "Database Systems", date: "2026-07-15", time: "09:00 AM - 12:00 PM", room: "LH-102", supervisor: "Dr. Rajesh Kumar" },
    { id: "T003", subject: "Operating Systems", date: "2026-07-16", time: "01:00 PM - 04:00 PM", room: "LH-101", supervisor: "Prof. Sarah Lin" }
  ]);
      ...
      <div className="grid md:grid-cols-3 gap-6">
          ...
          <div className="overflow-x-auto">
            <table className="w-full text-sm">
              <thead className="border-b">
                <tr>
                  {["Subject Name", "Date & Time", "Location Venue", "Supervisor Assigned", "Actions"].map(col => (
        ...
        <Card>
          ...
          <form onSubmit={handleAdd} className="space-y-4">
            ...
            <div className="flex flex-col gap-1">
              <label className="text-xs font-semibold text-muted-foreground">Invigilator Supervisor</label>
              <select
                value={newSupervisor}
