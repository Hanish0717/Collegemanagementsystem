...
import { Download, DollarSign, Filter, Plus, Search, Send, X, Loader2, MapPin, Activity, Navigation, User, AlertTriangle, ShieldCheck } from "lucide-react";
...
export function AdminFees() {
  ...
  const handleAllocateRoute = async () => {
    ...
    try {
      ...
      toast.success(`Transport route allocated and annual fee recorded for ${selectedTransStudent.fullName}!`);
      // Reset form
