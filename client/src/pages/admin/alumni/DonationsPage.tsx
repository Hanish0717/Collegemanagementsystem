...
export function DonationsPage() {
  ...
  const topDonors = [
    { id: 1, name: "Alexander Pierce", batch: "1995", amount: "$50,000", campaign: "New Library Fund" },
    { id: 2, name: "Sarah Connor", batch: "2001", amount: "$25,000", campaign: "Scholarship Program" },
    { id: 3, name: "Tech Innovators Corp", batch: "Corporate", amount: "$100,000", campaign: "Research Lab" }
  ];
  ...
  return (
    <div className="p-6 md:p-8 space-y-8 max-w-[1600px] mx-auto pb-24">
      ...
      >
        <Button className="rounded-xl bg-white text-green-600 hover:bg-white/90">New Campaign</Button>
      </GradientHeader>

      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
        <StatCard title="Total Raised (YTD)" value="$245,000" icon={DollarSign} color="green" trend={{ value: 24.5, isPositive: true }} />
        <StatCard title="Active Campaigns" value="4" icon={TrendingUp} color="blue" />
        <StatCard title="Total Donors" value="1,245" icon={Users} color="purple" trend={{ value: 12, isPositive: true }} />
        ...
        <div className="xl:col-span-2 space-y-8">
          ...
          <GlassCard className="p-6">
            <div className="flex items-center justify-between mb-6">
              ...
              <Button variant="ghost" size="sm" className="rounded-xl text-emerald-600">View All</Button>
            </div>
            <StyledTable headers={["Donor", "Batch", "Amount", "Campaign", "Recognition"]}>
              {topDonors.map(donor => (
                <TableRow key={donor.id}>
                  ...
                  <TableCell><span className="font-bold text-emerald-600">{donor.amount}</span></TableCell>
          ...
          <GlassCard className="p-6 bg-gradient-to-br from-emerald-500/10 to-teal-500/10 border-emerald-500/20">
            ...
            <div className="space-y-4">
              <div className="w-full h-40 bg-muted rounded-2xl overflow-hidden relative">
                <img src="https://images.unsplash.com/photo-1541339907198-e08756dedf3f?w=800&q=80" alt="Library" className="w-full h-full object-cover" />
              ...
              <Button className="w-full rounded-xl bg-emerald-600 hover:bg-emerald-700">Manage Campaign</Button>
            </div>
          </GlassCard>
        </div>
      </div>
