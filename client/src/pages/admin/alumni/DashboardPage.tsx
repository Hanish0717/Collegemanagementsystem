...
import { LayoutDashboard, Users, GraduationCap, DollarSign, Briefcase, Calendar, ChevronRight } from "lucide-react";
import { Button } from "@/components/ui/button";

export function DashboardPage() { console.log("DashboardPage Rendered");
  ...
  const growthData = [
    { name: "Jan", alumni: 4000 }, { name: "Feb", alumni: 4500 },
    { name: "Mar", alumni: 5100 }, { name: "Apr", alumni: 6200 },
    { name: "May", alumni: 7800 }, { name: "Jun", alumni: 8900 }
  ];
        ...
        <GlassCard className="p-6 flex flex-col">
          ...
          <div className="grid grid-cols-2 gap-4 flex-1">
            {[
              ...
              <button key={i} className="flex flex-col items-center justify-center p-4 rounded-2xl border bg-card hover:bg-muted/50 transition-colors gap-3 group">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
        <div>
          <div className="flex items-center justify-between mb-6">
            ...
            <Button variant="ghost" className="text-primary rounded-xl">View All <ChevronRight className="w-4 h-4 ml-1" /></Button>
          </div>
