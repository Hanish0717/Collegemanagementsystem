...
export function StoriesPage() {
  const stories = [
    {
      id: 1,
      title: 'From Campus to Y Combinator',
      name: 'David Chen',
      batch: '2018',
      excerpt: 'How our alumni network helped secure initial funding...',
      image: 'https://images.unsplash.com/photo-1552581234-26160f608093?w=800&q=80',
    },
    {
      id: 2,
      title: 'Pioneering Green Tech',
      name: 'Sarah Connor',
      batch: '2015',
      excerpt: 'Building sustainable solutions for the future of urban transport...',
    ...
    <div className="p-6 md:p-8 space-y-8 max-w-[1200px] mx-auto pb-24">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
        {stories.map((story) => (
          <GlassCard
            key={story.id}
            className="overflow-hidden flex flex-col group cursor-pointer hover:shadow-lg transition-all duration-300"
          >
            <div className="h-64 overflow-hidden relative">
              ...
              <div className="absolute bottom-4 left-4 z-20 text-white">
                ...
                <p className="text-sm text-white/80 font-medium flex items-center gap-2">
                  <Star className="w-4 h-4 fill-amber-500 text-amber-500" /> {story.name} • Class of{' '}
                  {story.batch}
                </p>
              </div>
            </div>
