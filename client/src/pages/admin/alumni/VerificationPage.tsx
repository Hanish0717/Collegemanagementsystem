...
export function VerificationPage() {
  ...
  const pendingList = pendingAlumni?.length > 0 ? pendingAlumni : [
    { id: "1", name: "Sarah Connor", batch: "2020", department: "Mechanical Engineering", appliedAt: "2024-03-15T10:30:00Z", docsCount: 2 },
    { id: "2", name: "John Smith", batch: "2018", department: "Electrical Engineering", appliedAt: "2024-03-14T14:20:00Z", docsCount: 1 }
  ];
  ...
  return (
    <div className="p-6 md:p-8 space-y-8 max-w-[1600px] mx-auto pb-24">
      ...
      <GlassCard className="p-6">
        <div className="flex items-center justify-between mb-6">
          ...
          {activeTab === 'pending' && (
            <div className="flex items-center gap-2">
              <Button variant="outline" size="sm" className="rounded-xl border-emerald-200 text-emerald-600 hover:bg-emerald-50"><CheckCircle2 className="w-4 h-4 mr-2"/> Bulk Approve</Button>
              <Button variant="outline" size="sm" className="rounded-xl border-rose-200 text-rose-600 hover:bg-rose-50"><XCircle className="w-4 h-4 mr-2"/> Bulk Reject</Button>
            </div>
          )}
        </div>
        ...
        <StyledTable headers={["Applicant", "Academic Info", "Submitted On", "Documents", "Actions"]}>
          {filteredList.map((app: any) => (
            <TableRow key={app.id}>
              ...
              <TableCell>
                <Button variant="ghost" size="sm" className="rounded-xl text-blue-600 bg-blue-50 hover:bg-blue-100">
