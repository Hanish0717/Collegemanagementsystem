        ...
        <Card>
          ...
          <div className="space-y-4 p-4 border rounded-xl bg-gradient-soft">
            <div className="grid sm:grid-cols-2 gap-4">
              <input
                defaultValue="Dr. Anjali Mehra"
                className="rounded-lg border bg-background px-3 py-2 text-sm"
              />
              <input
                defaultValue="super.admin@college.edu"
                className="rounded-lg border bg-background px-3 py-2 text-sm"
              />
              <input
            ...
            <textarea
              defaultValue="Responsible for global platform governance, institutional workflows and administrative security."
              rows={4}
        ...
        <Card>
          ...
          <div className="space-y-3">
            {[
              ...
              <label
                key={setting}
                className="flex items-center gap-2 p-3 rounded-xl border hover:bg-accent/50 transition"
              >
