...
export function PlacementSettings() {
  ...
  const fullName = user?.fullName || "Placement Officer";
  ...
  useEffect(() => {
    const role = "placement-officer";
    
    const storedAbout = localStorage.getItem(`cms_${role}_about`);
    setAboutMe(storedAbout || "Experienced placement officer with years of industry recruitment and college placement management expertise.");
  ...
  const placementIdVal = user?.employeeId || "PLC-0001";
    ...
    <div className="space-y-6">
      <div className="mb-2">
        ...
        <h2 className="text-sm font-medium text-muted-foreground">
          Manage campus drives and student placements
        </h2>
      </div>
        ...
        <div className="lg:col-span-2 space-y-6">
          ...
          <Card>
            ...
            <div className="grid sm:grid-cols-2 gap-4">
              ...
              <div className="p-3.5 border rounded-xl bg-gradient-soft">
                <label className="text-[10px] font-bold text-muted-foreground uppercase tracking-wider">
                  Placement Officer ID
                </label>
                <div className="text-sm font-semibold mt-1 font-mono">{placementIdVal}</div>
              </div>
            </div>
          </Card>
        </div>
