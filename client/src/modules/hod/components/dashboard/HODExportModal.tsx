      ...
      <div className="bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-3xl p-6 max-w-md w-full shadow-2xl relative animate-in fade-in zoom-in-95 duration-150">
        ...
        <div className="mt-5 space-y-2.5">
          ...
          >
            ...
            <div>
              <p className="font-extrabold text-slate-900 dark:text-white text-xs">Export as PDF Document</p>
              <p className="text-[10px] text-slate-500 font-medium">Includes high-resolution charts & executive summary</p>
            </div>
          </button>
          ...
          >
            ...
            <div>
              <p className="font-extrabold text-slate-900 dark:text-white text-xs">Export as Excel Spreadsheet (.xlsx)</p>
