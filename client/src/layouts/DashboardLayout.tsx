        ...
        <div className="flex-1 flex flex-col min-w-0">
          <header className="sticky top-0 z-30 h-16 glass border-b flex items-center gap-4 px-6 justify-between">
            ...
            <div className="ml-auto flex items-center gap-2">
              {/* Role Indicator */}
              <div className={`inline-flex items-center gap-1.5 px-3 py-1.5 rounded-xl text-xs font-semibold text-white bg-gradient-to-r ${role.gradient} select-none shadow-soft`}>
