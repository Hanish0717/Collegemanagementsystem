            ...
            <div className="flex items-center gap-2 shrink-0">
              ...
              <div className="relative">
                <button
                  ...
                  className={`hidden lg:inline-flex items-center gap-1.5 px-3 py-1.5 rounded-full text-[11px] font-semibold text-white bg-gradient-to-r ${role.gradient} cursor-pointer hover:opacity-90 transition shadow-xs`}
                >
                ...
                {showRoleInfo && (
                  <>
                    ...
                    <div className="absolute right-0 top-full mt-2 w-64 bg-background border rounded-xl shadow-lg z-50 p-4 animate-in fade-in slide-in-from-top-2 duration-150">
                      <div className="flex items-center gap-2 pb-2.5 border-b mb-2.5">
                        <Info className="size-4 text-violet-600" />
                        <h4 className="font-bold text-xs text-gradient">Workspace Credentials</h4>
                      </div>
                      <div className="space-y-1.5 text-[11px]">
                        ...
                        <div className="flex justify-between">
                          ...
                          <span className="font-semibold">Central Main Library</span>
                        </div>
                        <div className="flex justify-between">
                        ...
                        <div className="flex justify-between">
                          ...
                          <span className="font-medium text-muted-foreground">Today, 08:32 AM</span>
                        </div>
                      </div>
                    </div>
                  </>
              ...
              <div className="relative">
                <button
                  ...
                  className="hidden md:inline-flex items-center gap-1.5 px-3.5 py-2 rounded-xl bg-gradient-primary text-primary-foreground text-sm font-semibold glow-primary cursor-pointer hover:opacity-95 transition"
                >
                ...
                {showNewActions && (
                  <>
                    ...
                    <div className="absolute right-0 top-full mt-2 w-56 bg-background border rounded-xl shadow-lg z-50 p-1.5 animate-in fade-in slide-in-from-top-2 duration-150">
                      {[
                        { id: "addBook", label: "Add Catalog Book", icon: BookOpen },
                        { id: "issueBook", label: "Allocate Book Issue", icon: History },
                        { id: "addMember", label: "Register New Member", icon: UserPlus },
                        { id: "addDigital", label: "Upload Digital Resource", icon: FileText },
                        { id: "sendNotif", label: "Broadcast Custom Alert", icon: BellRing },
                      ].map((action) => (
                        <button
                          key={action.id}
                          onClick={() => {
                          ...
                          className="w-full flex items-center gap-2.5 px-3 py-2 text-xs font-semibold hover:bg-gradient-soft text-muted-foreground hover:text-foreground rounded-lg transition text-left cursor-pointer"
                        >
                          <action.icon className="size-4 text-violet-600" />
                          {action.label}
                        </button>
                      ))}
                    </div>
              ...
              <button
                ...
                className="p-2 rounded-lg hover:bg-accent cursor-pointer transition flex items-center justify-center"
              ...
              <div className="relative">
                <button
                  ...
                  className="relative p-2 rounded-lg hover:bg-accent cursor-pointer transition flex items-center justify-center"
                ...
                {showNotifications && (
                  <>
                    ...
                    />
                    <div className="absolute right-0 top-full mt-2 w-80 bg-background border rounded-xl shadow-lg z-50 p-3 animate-in fade-in slide-in-from-top-2 duration-150">
                      <div className="flex items-center justify-between pb-2 border-b mb-2">
                        <span className="font-bold text-xs">
                          Alert Notifications ({unreadCount})
                        </span>
                        {unreadCount > 0 && (
                          <button
                        ...
                        {localNotifications.length === 0 ? (
                          ...
                          localNotifications.slice(0, 5).map((n) => (
                            <div
                              ...
                              onClick={() => {
                                markSingleRead(n.id);
                                toast.info(`Broadcast detail: ${n.title}`);
                              }}
                              className={`p-2 rounded-lg text-xs border transition cursor-pointer flex items-start gap-2 ${
                                n.unread ? "bg-gradient-soft border-primary/20" : "bg-background"
                              }`}
                            >
                              <div
              ...
              <div className="relative">
                ...
                >
                  <div
                    className={`size-7 rounded-lg bg-gradient-to-br ${role.gradient} text-white font-bold text-xs grid place-items-center`}
                  >
                    AS
                  </div>
                  ...
                  <>
                    ...
                    <div className="absolute right-0 top-full mt-2 w-56 bg-background border rounded-xl shadow-lg z-50 p-1.5 animate-in fade-in slide-in-from-top-2 duration-150">
                      ...
                      <button
                        ...
                        className="w-full flex items-center gap-2.5 px-3 py-2 text-xs font-semibold hover:bg-rose-50 text-rose-600 rounded-lg transition text-left cursor-pointer"
                      >
                        <LogOut className="size-4" />
                        Logout System
                      </button>
