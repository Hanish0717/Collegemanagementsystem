...
export async function deleteAssessment(id: string): Promise<boolean> {
  try {
    const res = await api.delete<{ success: boolean }>(`/assessments/${id}`);
...
export async function fetchPlacementDrives(): Promise<any[]> {
  try {
    ...
    // Fallback to placement dashboard endpoint
    ...
    return [
      { id: 'd1111111-1111-1111-1111-111111111111', company_name: 'TechCorp Solutions', job_title: 'Software Development Engineer', drive_date: '2026-08-05', status: 'Upcoming' },
      { id: 'd2222222-2222-2222-2222-222222222222', company_name: 'Innovate Systems', job_title: 'Frontend Developer', drive_date: '2026-08-10', status: 'Upcoming' },
      { id: 'd3333333-3333-3333-3333-333333333333', company_name: 'Global Data Inc', job_title: 'Data Analyst', drive_date: '2026-08-15', status: 'Upcoming' }
    ];
  }
}
