...
export const ROLES: Record<RoleId, Role> = {
  ...
  librarian: {
    ...
    nav: [
      ...
      { to: '/dashboard/librarian/id-cards', label: 'Student ID Cards', icon: Award },
  ...
  hod: {
    ...
    nav: [
      ...
      { to: '/hod/students', label: 'Student Management', icon: Users },
      { to: '/hod/faculty', label: 'Faculty Management', icon: GraduationCap },
      { to: '/hod/academics', label: 'Academic Management', icon: BookOpen },
      { to: '/hod/attendance', label: 'Attendance', icon: CalendarCheck },
      { to: '/hod/examinations', label: 'Examinations', icon: Award },
      { to: '/hod/timetable', label: 'Timetable', icon: Clock },
      { to: '/hod/mentoring', label: 'Mentoring', icon: Heart },
      { to: '/hod/research', label: 'Research', icon: FlaskConical },
      { to: '/hod/resources', label: 'Resources', icon: Database },
      { to: '/hod/approvals', label: 'Approvals', icon: ClipboardList },
      { to: '/hod/events', label: 'Events', icon: Sparkles },
      { to: '/hod/reports', label: 'Reports', icon: Activity },
      { to: '/hod/communication', label: 'Communication', icon: MessageSquare },
      { to: '/hod/documents', label: 'Documents', icon: FileText },
