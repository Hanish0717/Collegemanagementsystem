...
export const ROLES: Record<RoleId, Role> = {
  ...
  admin: {
    ...
    nav: [
      base,
      { to: '/dashboard/admin/faculty', label: 'User Management', icon: Users },
      ...
      { to: '/dashboard/admin/workflows', label: 'Approval Workflow', icon: ClipboardList },
      { to: '/dashboard/super-admin/security', label: 'Activity Logs', icon: Shield },
  ...
  principal: {
    ...
    nav: [
      ...
      { to: '/dashboard/admin/faculty', label: 'Faculty Roster', icon: GraduationCap },
  ...
  vice_principal: {
    id: 'vice_principal',
    name: 'Vice Principal',
    short: 'Executive Vice Lead',
    description: 'Institutional management, user administration, department oversight, and academic operations.',
    icon: ShieldCheck,
    gradient: 'from-blue-600 to-blue-700',
    accent: 'bg-blue-600',
    nav: [
