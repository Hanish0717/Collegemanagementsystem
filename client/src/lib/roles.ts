...
export const ROLES: Record<RoleId, Role> = {
  ...
  dean: {
    ...
    nav: [
      ...
      { to: "/dashboard/admin/exams", label: "Exams Portal", icon: BookOpen },
      { to: "/dashboard/admin/lms", label: "LMS Curriculum", icon: FileText },
  ...
  exam_cell: {
    ...
    nav: [
      base,
      { to: "/dashboard/admin/exams", label: "Seating & Roster", icon: BookOpen },
      { to: "/dashboard/admin/reports", label: "Grade Distributions", icon: Activity },
      notif,
      settings,
    ],
  },
