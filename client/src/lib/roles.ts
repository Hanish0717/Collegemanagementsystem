...
export const ROLES: Record<RoleId, Role> = {
  super_admin: {
    ...
    nav: [
      ...
      { to: "/dashboard/admin/payroll", label: "Payroll Management", icon: DollarSign },
  ...
  faculty: {
    ...
    nav: [
      { to: "/faculty/dashboard", label: "Dashboard", icon: LayoutDashboard, exact: true },
      ...
      { to: "/faculty/lms", label: "LMS Portal", icon: FileText },
      { to: "/faculty/students", label: "Counselling", icon: HeartHandshake },
      { to: "/faculty/messages", label: "Message Hub", icon: MessageSquare },
