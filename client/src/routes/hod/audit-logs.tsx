...
const auditLogsConfig = {
  slug: 'audit-logs',
  title: 'Department Security Audit Logs',
  subtitle: 'Track all HOD and faculty administrative actions, mark changes, leave signoffs, and record modifications.',
  icon: ShieldAlert,
  stats: [
  ...
  sampleData: [
    { id: 'LOG-1001', time: '2026-07-20 04:30 PM', action: 'Approved Faculty Leave (Dr. Ramesh)', user: 'Dr. Anjali Mehra (HOD)', role: 'Head of Department', ip: '192.168.1.45', status: 'Success' },
    { id: 'LOG-1002', time: '2026-07-20 02:15 PM', action: 'Signed Off Mid-Term 1 Marksheet (AIML501)', user: 'Dr. Anjali Mehra (HOD)', role: 'Head of Department', ip: '192.168.1.45', status: 'Success' },
    { id: 'LOG-1003', time: '2026-07-19 11:20 AM', action: 'Dispatched Attendance Shortage Warnings', user: 'Dr. Anjali Mehra (HOD)', role: 'Head of Department', ip: '192.168.1.45', status: 'Success' },
  ],
  columns: [
    { key: 'id', header: 'Audit Ref', render: (i: any) => <span className="font-mono font-bold text-blue-600">{i.id}</span> },
    ...
    { key: 'status', header: 'Result', render: (i: any) => <span className="px-2 py-0.5 rounded-full text-[10px] font-extrabold bg-emerald-100 text-emerald-800">{i.status}</span> },
  ],
};

export const Route = createFileRoute('/hod/audit-logs')({
  component: () => <HODSubModulePage config={auditLogsConfig} />,
});
